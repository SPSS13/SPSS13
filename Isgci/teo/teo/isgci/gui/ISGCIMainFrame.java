...
public class ISGCIMainFrame extends JFrame implements WindowListener,
	...
	public ISGCIMainFrame(teo.Loader loader) {
		...
		/*
		 * Add undomanager and undohandler to the mainframe by registrating to the graph in the mxGraphComponent
		 */
		...
		mxIEventListener undoHandler = new mxIEventListener()
		{
			public void invoke(Object source, mxEventObject evt)
			{
				...
				((mxGraphComponent)drawingPane).getGraph().setSelectionCells(((mxGraphComponent)drawingPane).getGraph()
...
//        viewMenu.add(bind(mxResources.get("redo"), new HistoryAction(false)));
