...
public class InclusionResultDialog extends JDialog implements ActionListener {
    ...
    private Collection<GraphClass> upper, lower;

    private static GraphClass node1, node2;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == okButton) {
            ...
            if (node1 != null  && node2 != null) {
                List<GraphClass> nodeList = new ArrayList<GraphClass>();
                nodeList.add(node1);
                nodeList.add(node2);
                System.out.println(node1.toString() + " , " + node2.toString());
                parent.graphCanvas.setNodeName(nodeList);
            }
