//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-07 08:29:56 GMT
//  from grammar 'C:\Users\Matthias\Documents\GitHub\
//    undom\Isgci\teo\teo\isgci\iq\iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean name()
    {
      ...
      if (!next('"',$Term9)) return reject(name);
      thename();
      if (!next('"',$Term15)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term4)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term16)) return reject(not);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term3)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term1)) return reject(and);
  ...
  final Cache $Term1 = new Cache("\"and\"");
  final Cache $Term2 = new Cache("\"(\"");
  final Cache $Term3 = new Cache("\"or\"");
  final Cache $Term4 = new Cache("[0-9]");
  ...
  final Cache $Term16 = new Cache("\"not\"");
