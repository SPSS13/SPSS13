//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-09 09:23:38 GMT
//  from grammar
//    'C:\Users\Matthias\Documents\GitHub\export\Isgci\teo\teo\isgci\iq\iq.
//    peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term1)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term11)) return reject(name);
      if (!next('"',$Term14)) return reject(name);
      thename();
      if (!next('"',$Term11)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('A','Z',$Term17)) return accept(idstart);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term0)) return reject(or);
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term13)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term1)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term0 = new Cache("\"or\"");
  final Cache $Term1 = new Cache("_");
  ...
  final Cache $Term17 = new Cache("[A-Z]");
