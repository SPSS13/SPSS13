//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-06-10 10:22:26 GMT
//  from grammar
//    'C:\Users\Matt\Documents\GitHub\SPSS13\Isgci\teo\teo\isgci\iq\iq.peg'
//    .
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term19)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean idchar()
    {
      ...
      if (next('_',$Term10)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term4)) return reject(not);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term6)) return reject(or);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term1)) return reject(lparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term19)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term4 = new Cache("\"not\"");
  final Cache $Term5 = new Cache("\">=\"");
  final Cache $Term6 = new Cache("\"or\"");
