...
public class ISGCIMainFrame extends JFrame implements WindowListener,
	...
	//new MenuItems for the Menu Selection
	...
	protected JMenuBar createMenus() {
		...
		// Adds a new Menu to the TopMenuBar named Selection with the respective MenuItems
		selectionMenu = new JMenu("Selection");
		//MenuItems
		selectionMenu.add(miToggleNeighbours = new JMenuItem("Toggle Neighbours"));
